<template>
	<vs-dialog v-model="active" :loading="loading" not-close prevent-close>
		...
		<div v-else class="con-form">
			...
			<vs-select v-model="newRoleData.permissions" placeholder="Permissions" block filter multiple>
				<vs-option
		...
		<template #footer>
			<div class="footer-dialog">
				<vs-button :loading="loading" block @click="createRole"> Add New </vs-button>
			</div>
		</template>
	</vs-dialog>
</template>
