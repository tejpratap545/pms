	...
	<div class="page">
		...
		<div class="center">
			<vs-navbar v-model="activeStage" center-collapsed>
				...
				<vs-navbar-item id="goals" :active="activeStage == 'goals'"> Goals </vs-navbar-item>
				<vs-navbar-item id="skills" :active="activeStage == 'skills'"> Skills </vs-navbar-item>
			</vs-navbar>
	...
	data: () => ({
		...
		steps: [
			...
			},
			{
				...
				content: 'Use this button to add category for goal, core values and skills'
			},
			{
				target: '.data-2',
				header: {
