	...
	<div class="page">
		...
		<div class="center">
			<vs-table v-model="selected">
				...
				<template #thead>
					<vs-tr>
						<vs-th sort @click="departmentList = $vs.sortData($event, departmentList, 'name')">
							Name
						</vs-th>
						<vs-th
							v-if="$store.state.user.user.is_superuser"
							sort
							@click="departmentList = $vs.sortData($event, departmentList, 'company')"
						>
							company
						</vs-th>
						<vs-th sort @click="departmentList = $vs.sortData($event, departmentList, 'id')">
							Id
						</vs-th>
					</vs-tr>
				</template>
