	...
	<div class="app">
		<vs-dialog v-model="active" class="dialog" not-close prevent-close>
			...
			<div v-else class="con-form">
				...
				<vs-input v-model="password1" type="password" placeholder="New password">
					<template #icon>
						<i class="bx bxs-lock"></i>
					</template>
				</vs-input>
				<vs-input v-model="password2" type="password" placeholder="Confirm password">
					<template #icon>
						<i class="bx bxs-lock"></i>
					</template>
				</vs-input>
			...
			<template #footer>
				<div class="footer-dialog">
					<vs-button block :loading="loading" @click="resetPassword"> Send email </vs-button>
				</div>
			</template>
		</vs-dialog>
	</div>
