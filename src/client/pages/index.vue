	...
	<div class="page">
		...
		<div v-else class="center">
			<div class="status-cards-group">
				<div class="card" style="background: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%)">
					<div class="icon">
				...
				<div class="card" style="background: linear-gradient(120deg, #a1c4fd 0%, #c2e9fb 100%)">
					<div class="icon">
				...
				<div class="card" style="background: linear-gradient(120deg, #d4fc79 0%, #96e6a1 100%)">
					<div class="icon">
				...
				<div class="card" style="background: linear-gradient(0deg, #fa709a 0%, #fee140 100%)">
					<div class="icon">
