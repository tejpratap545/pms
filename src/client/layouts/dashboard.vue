<template>
	<div class="hidden">
		<vs-sidebar v-model="active" :reduce="reduce" square open>
			...
			<vs-sidebar-group
				v-if="$store.state.user.user.is_superuser || $store.state.user.user.is_admin"
			>
				<template #header>
			...
			<vs-sidebar-item v-if="$store.state.user.user.is_admin" id="records" to="/sections/records">
				<template #icon>
