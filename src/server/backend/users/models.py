...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    contact_number = models.CharField(blank=True, null=True, unique=True)
...
class Department(models.Model):
    ...
    manager = models.ForeignKey("Profile", blank=True, null=True)
...
class Profile(models.Model):
    ...
    martial_status = models.CharField(
        max_length=50, choices=MARITAL_STATUS_CHOICE, blank=True, null=True
    )
    ...
    employment_type = models.CharField(
        max_length=50, choices=EMPLOYMENT_TYPE_CHOICE, blank=True, null=True
    )
    ...
    first_reporting_manager = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="first_reporting_manager",
    )
